...
namespace NESSharp.Hardware
{
    ...
    public class CPU6502
    {
        ...
        byte BIT()
        {
            ...
            SetFlag(FLAGS6502.N, (byte)(_fetchedData & 0xFF) == 0x80);
            SetFlag(FLAGS6502.V, (byte)(_fetchedData & 0xFF) == 0x40);
        ...
        public SortedList LoadDisassembly(ushort start, ushort end)
        {
            ...
            while (addr < end)
            {
                ...
                if (!returnDisassembly.ContainsKey(line_addr))
